...
parser.add_argument("--basic-trader-trigger-min", dest = "basic_trader_trigger_min", type = float, default=1.0, help = "minimum sec for basic trader trigger",required=True )
