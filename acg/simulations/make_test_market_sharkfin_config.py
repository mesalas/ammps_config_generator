...
parser.add_argument("--dividend_entry", dest="entry_threshold_max", type = float, help = "Threshold deviation from fundamental price before dividend inst enters")
parser.add_argument("--n_dividend_inst", dest="n_dividend_institutions", type = float, help = "number of dividend institutions")
parser.add_argument("--dividend_inst_cash", dest="cash_dividend_institutions", type = float, help = "starting cash of dividend inst")
...
if __name__ == "__main__":
    ...
    n_dividend_institutions = args.n_dividend_institutions
    entry_threshold_max = args.entry_threshold_max
    cash_dividend_institutions = args.cash_dividend_institutions
    ...
    n_dls_institutions = n_dividend_institutions
    name = "DividendInstitution"
    entry_threshold_max = 0.1
    dividend_longshort_institutions.parameters["entryThreshold"] = [0.01, entry_threshold_max]
    dividend_longshort_institutions.parameters["initialCash"] = cash_dividend_institutions
